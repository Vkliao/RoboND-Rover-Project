...
class RoverState():
    def __init__(self):
        ...
        self.start_pos = None # Initial position (x, y)
        ...
        self.obs_angles = None # Angles of obsticle pixels
        self.obs_dist = None # Distances of obsticle pixels
        self.rock_angles = None # Angles of rock pixels
        self.rock_dist = None # Distances of rock pixels
        self.nav_angles = None # Angles of navigable terrain pixels
        self.nav_dist = None # Distances of navigable terrain pixels
